...
print(f"City & postal code: {citypostalcode}")
...
word3 = input("Enter the 3rd word: ")
...
print(f"In {year}, {name} went on a very funsies adventure! A dragon attacked her village byt she saved her village!!! Yippe!")
